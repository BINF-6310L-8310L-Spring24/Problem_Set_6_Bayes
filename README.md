...
2. Use the `optimize()` function in R to find the &theta; with the maximum posterior value based on this new sample set. Using this maximum posterior value (probability), what is the probability that in the five samples you will get 3 containing a sample of *B. harpocrates*
